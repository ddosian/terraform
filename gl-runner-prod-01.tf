...
resource "dockhand_environment" "gl-runner-prod-01_dockhand_environment" {
  ...
  ca_cert         = local.gl-runner-prod-01_ca
  client_cert     = local.gl-runner-prod-01_cert
  client_key      = local.gl-runner-prod-01_key
  icon            = "server"
}
...
resource "authentik_certificate_key_pair" "gl-runner-prod-01-ca_authentik_key_pair" {
  ...
  certificate_data = local.gl-runner-prod-01_ca
  lifecycle {
...
resource "authentik_certificate_key_pair" "gl-runner-prod-01-client_authentik_key_pair" {
  ...
  certificate_data = local.gl-runner-prod-01_cert
  key_data         = local.gl-runner-prod-01_key
  lifecycle {
    ignore_changes = [certificate_data, key_data]
  }
}
