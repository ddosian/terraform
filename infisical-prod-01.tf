...
resource "dockhand_environment" "infisical-prod-01_dockhand_environment" {
  ...
  ca_cert         = file("${path.module}/../ansible/docker-keys/infisical-prod-01/ca.pem")
  client_cert     = file("${path.module}/../ansible/docker-keys/infisical-prod-01/cert.pem")
  client_key      = file("${path.module}/../ansible/docker-keys/infisical-prod-01/key.pem")
  icon            = "server"
}
...
resource "authentik_certificate_key_pair" "infisical-prod-01-ca_authentik_key_pair" {
  ...
  certificate_data = file("${path.module}/../ansible/docker-keys/infisical-prod-01/ca.pem")
  lifecycle {
...
resource "authentik_certificate_key_pair" "infisical-prod-01-client_authentik_key_pair" {
  ...
  certificate_data = file("${path.module}/../ansible/docker-keys/infisical-prod-01/cert.pem")
  key_data         = file("${path.module}/../ansible/docker-keys/infisical-prod-01/key.pem")
}
